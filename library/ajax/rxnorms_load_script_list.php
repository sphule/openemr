...
ini_set('memory_limit', '150M');
 ...
 $file = file_get_contents($dirScripts.'/Table_scripts_mysql_rxn.sql', true);
 $data = file_get_contents($dirScripts.'/Load_scripts_mysql_rxn_unix.sql', true);
 $indexes = file_get_contents($dirScripts.'/Indexes_mysql_rxn.sql', true);
