...
<head>
	...
	<? require_once($GLOBALS['webserver_root']."/interface/forms/nurse_note/nurse_note.js.php"); ?>
...
<?//echo $top_bg_line;?> 
<body class="body_top" topmargin='0' rightmargin='0' leftmargin='2' bottommargin='0' marginwidth='2' marginheight='0'>
...
<form method='post' action="<?echo $rootdir?>/forms/nurse_note/save.php" name='nursenote' id='nursenote' >


<script language="javascript">

	required_fields = new Array(
						new Array('nurses_notes',	'nonempty',		"Please describe the nurse notes"));
...
<tr>
	<td bgcolor="black" align=center colspan=2>
		<span class=bold><font color=white>NURSES NOTE</font></span>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<tr>
 ...
 ?>
 <? prev_textarea("nurses_notes", "cols='40' rows='5' wrap='virtual' style='width:100%'"); ?> <p>
